...
class svm_al(object):
    ...
    def one_train(self, svm1, data_L, data_U, expert_exact_percent):
        ...
        # data_U_process = data_U

        # print(data_U_process)

        data_U_process = scalar1.transform(data_U_process)

        probility = svm1.predict_proba(data_U_process)
        ...
        data_U = data_U.drop(index=index) 
        ...
        for system in systerm_list:
            for s_number in s_number_list:
                ...
                for number in number_list:
                    ...
                    out.to_csv('svm_al.csv', index=False, mode='a+', header=None)
                    print("----------------------")
